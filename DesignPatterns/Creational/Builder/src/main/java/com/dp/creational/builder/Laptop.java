...
public class Laptop {
	...
	/*
	 * Make private constructor of Laptop(outer class) so that direct object
	 * creation can be prevented and Object can be created only by calling
	 * LaptopBuilder:build() Initialize all instance variables of Laptop(outer
	 * class) from LaptopBuilder
	 */
	...
	/**
	 * Internal class LaptopBuilder, which has public constructor to initializes
	 * required/Mandatory fields and we have setter methods for all Optional fields
	...
	public static class LaptopBuilder {
		...
		/*
		 * Only one way to create Laptop Object by calling LaptopBuilder:build()
		 */
		public Laptop build() {
